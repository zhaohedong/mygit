...
int test_emplace_2()
{
	...
	*/
	...
	std::vector<President> newElections;
	std::cout << "\npush_back&&:\n";
	President newPresident = President("Franklin Delano Roosevelt", "the USA", 1936);
	newElections.push_back(std::move(newPresident));

	std::vector<President> copyElections;
	std::cout << "\npush_back copy:\n";
	President copyPresident("Franklin Delano Roosevelt", "the USA", 1936);
	President copyPresident2= copyPresident;
//	copyElections.push_back(copyPresident2);
...
int main()
{
	emplace_::test_emplace_1();
	emplace_::test_emplace_2();	
	emplace_::test_emplace_3();
	emplace_::test_emplace_4();
